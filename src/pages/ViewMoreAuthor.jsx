  ...
  return (
    <div>
      <div className="bg-[#212140] h-screen w-full ">
        <div className="py-28 ">
          <div className="w-full border bg-gray-400 px-32 py-2">
            <div className="px-32 flex flex-row space-x-6 items-center ">
                <img className="w-[60px]" src={movies.poster_path} />
                <div>
                    <div className="text-3xl font-main text-[#f20000]">{movies.title}</div>
                    ...
                    <div className="space-y-4">
                        {movies?.cast.map((item) => (
                            <div className="flex flex-row items-center space-x-4">
                                <img src={item.img_cast} className="h-[80px] w-[80px] rounded"/>
                                <p className="text-xl">{item.name_cast}</p>
                            </div>
                        ))}
                    </div>
                </div>
                <div className="w-[50%]">Dir</div>
              </div>
            </div>
          </div>
        </div>
